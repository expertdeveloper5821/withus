...
const handleItemClick = (item: string) => {
  ...
  // You can implement other logic here, like navigation or state changes
};
...
{/*           
          ...
          //<FeatureScroller  items={productCollections.map((col) => col.title)} showArrow={false} mainScollClassName="flex gap-2 overflow-x-auto md:overflow-x-auto lg:overflow-x-hidden scrollbar-hide scroll-smooth mt-2 md:ml-6 pr-10 w-[90%]" itemClassName="border border-[#00000080] rounded-[40px]  px-[15px] sm:px-[35px] py-[7px] sm:py-[14px] font-normal text-[18px] leading-[1.5]  whitespace-nowrap text-black"/>
          </div> */}
