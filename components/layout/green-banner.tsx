  ...
  return (
    <div className="  text-white rounded-lg  border rounded-[20px] " style={{  borderColor: '#0A8800 '}}>
      <div className="flex items-center justify-between py-3 px-8 rounded-t-[7px]" style={{ backgroundColor:'#0A8800'}}>
        <h3 className=" flex items-center text-[14px] w-[500px]">
        <Image
      ...
      <div className="flex items-center justify-between  bg-white text-green-700  p-3 px-4 border-b  rounded-b-[12px]">
        ...
        <a href="#" className="text-green  text-right text-[14px] w-[400px] ml-4">
          {linkText}
        </a>
      </div>
    </div>
